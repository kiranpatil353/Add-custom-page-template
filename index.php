 ...
 * Description:		   Add dynamic template files, And view listing for all custom template files in theme with linked pages.
 * Version: 		   1.0
 * Author: 		       kiranpatil353
 */
// Add admin Top menu 
function acpt_admin_menu() {
    add_menu_page('Theme Templates', 'Theme Templates', 'manage_options', 'my-top-level-handle', 'acpt_custom_pages_list');
}
...
function acpt_add_submenu_page() {
    add_submenu_page(
            'my-top-level-handle', 'Add Template', 'Add Template', 'manage_options', 'addnew_template', 'acpt_add_options_function'
    );
}
